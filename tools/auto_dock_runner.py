...
def make_args(cli):
    ...
    return SimpleNamespace(
        ...
        webcam_ip="", image_topic="",
        tape_image_topic="/ascamera/camera_publisher/rgb0/image",
        secondary_image_topic="", secondary_video_url="",
        ...
        arrival_topic=f"{robot_namespace}/nav2/arrival",
        auto_dock_stop_topic=f"{robot_namespace}/auto_dock/stop",
        auto_dock_status_topic=f"{robot_namespace}/auto_dock/status",
        dock_inventory_topic=f"{robot_namespace}/dock/inventory",
        dock_inventory_reset_topic=f"{robot_namespace}/dock/inventory/reset",
        fork_state_topic=f"{robot_namespace}/fork/state",
        drive_ready_topic=f"{robot_namespace}/auto_dock/drive_ready",
        map_topic="/map", entity_map_topic=f"{robot_namespace}/tag_entity_map",
