...
class TestPanelNode(Node):
    def __init__(self, vehicle, log_callback):
...
class TestPanel:
    def __init__(self, root, args):
        ...
        self.node = TestPanelNode(args.vehicle, self.append_log)
        self.action_buttons = []
        self.build_ui()
        self.update_enabled()
    ...
    def build_ui(self):
        ...
        nav = ttk.LabelFrame(self.root, text="Nav2 담당자 대신 arrival 발행", padding=10)
        ...
        approach = ttk.LabelFrame(
            self.root, text="Nav2 담당자 대신 approach_result 발행", padding=10
        )
        ...
        quick = ttk.LabelFrame(self.root, text="빠른 Arrival", padding=10)
        ...
        fork = ttk.LabelFrame(self.root, text="Fork 담당자 대신 완료 발행", padding=10)
        ...
        log_frame = ttk.LabelFrame(self.root, text="토픽 송수신 로그", padding=6)
