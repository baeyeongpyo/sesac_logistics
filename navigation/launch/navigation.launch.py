...
def launch_setup(context):
    ...
    params_name = 'nav2_params.yaml' if robot_name == '/' else f"nav2_params_{robot_name.strip('/')}.yaml"
    ...
    navigation_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'params_file': os.path.join(navigation_package_path, 'config', params_name),
