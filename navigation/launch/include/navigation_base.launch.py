...
def launch_setup(context):
    ...
    container_name_full = ('/', container_name) if not namespace_str else ('/', namespace_str, '/', container_name)
    ...
    if use_namespace == 'true':
        controller_param = controller_param.replace('.yaml', f"_{namespace.perform(context).strip('/')}.yaml")
